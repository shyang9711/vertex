...
def init_profile_tab(
    ...
    lbl_received = ttk.Label(tracker_card, text="Received files: —")
    lbl_received.pack(anchor="w")
    lbl_reminders = ttk.Label(tracker_card, text="Active reminders: —")
    lbl_reminders.pack(anchor="w")
    ...
    def _refresh_tracker_summary():
        ...
        try:
            ...
            lbl_received.config(text=f"Received files: {s['received']}")
            lbl_reminders.config(text=f"Active reminders: {s['active_reminders']}")
